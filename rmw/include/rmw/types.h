...
typedef struct RMW_PUBLIC_TYPE rmw_message_info_s
{
   ...
   * Publishers gid generated by rmw implementations might at some point collide, in which
   * case it's not posible to distinguish from which message was the publisher.
